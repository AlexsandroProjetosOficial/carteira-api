/*
  ...
  - Added the required column `virtualAccountId` to the `creditCards` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_creditCards" ("cardNumber", "createdAt", "creditCardName", "deletedAt", "expirationDay", "flagId", "id", "limit", "securityCode", "sinceMember", "status", "updatedAt", "validThru") SELECT "cardNumber", "createdAt", "creditCardName", "deletedAt", "expirationDay", "flagId", "id", "limit", "securityCode", "sinceMember", "status", "updatedAt", "validThru" FROM "creditCards";
